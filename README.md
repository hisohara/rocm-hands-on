...
make transpose_read_contiguous ROCM_GPU=gfx942
...
```bash
make transpose_write_contiguous ROCM_GPU=gfx942
...
```bash
make transpose_tiled ROCM_GPU=gfx942
./transpose_tiled
```
...
```bash
make transpose_rocblas ROCM_GPU=gfx942
./transpose_rocblas
```
...
```bash
make transpose_timed ROCM_GPU=gfx942
./transpose_timed
```
...
make CXX=amdclang++ ROCM_GPU=gfx942
